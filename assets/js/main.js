...
angular.module('app')
    // Controllers 
    .controller('AppCtrl', ['$scope', '$translate', '$window', '$ngSilentLocation', '$timeout', '$http', 'appConfig', 'Lightbox', '$location', '$rootScope',
        function($scope, $translate, $window, $ngSilentLocation, $timeout, $http, appConfig, Lightbox, $location, $rootScope) {
